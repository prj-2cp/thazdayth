export const kab = {
    ...
    footer: {
        subtitle: "Lbaḍna n uzemmur, seg idurar ɣer ttebla-inek.",
        contact: "Contact",
        menu: "Umuɣ",
        legal: "Légal",
        social: "Réseaux",
        copyright: "© 2024 TAZDAYTH. Akk izerfan ḥerzen.",
        legal_links: ["Timawin", "Privacité", "Cookies"],
        address: "Abrid n Lemɛisra, Lḥayzer, Tubiret"
    },
    process: {
        hero: {
            badge: "Abrid-nneɣ",
    ...
    boutique: {
        ...
        press: {
            ...
            service_title: "Aḥraẓ n uɛṣar",
            service_desc: "Eǧǧ-aɣ azemmur-inek. Amlas-nneɣ ad k-id-yessiwal akken ad nsentem azemz.",
            oil_type_wanted: "Taggayt n zzit i tebɣiḍ",
            oil_type_tooltip: "Taggayt n zzit tetteddu d ssuma n uxeddim.",
            conversion_info: "{{rate}} kg → 1L · {{price}} DA/kg",
            quantity_kg: "Lqeṛ n uzemmur (kg)",
            quantity_tooltip: "S drus 50 kg.",
            quantity_placeholder: "Am: 500",
            min_error: "Lqeṛ n uzemmur s drus d 50 kg.",
            payment_method: "Tarrayt n lxelaṣ",
            payment_tooltip: "Tedrimt : ssuma yezgan.\nPourcentage : tekkseḍ amur seg zzit i d-yeffɣen.",
            money: "Tedrimt (DA)",
            percentage: "% n zzit",
            percentage_info: "seg zzit i d-yeffɣen ad t-yeṭṭef ufellaḥ am lxelaṣ n uɛṣar.",
            estimation: "Asekyed",
            est_prod: "Zzit i d-iteddun",
            est_producer_share: "Amur n ufellaḥ",
            est_cost: "Ssuma n uxeddim",
            est_your_oil: "Zzit-inek",
            method: "Tarrayt n uɛṣar",
            method_desc: "Nessexdam tarrayt n semi-automatique s ssuma yezgan.",
            method_name: "Tarrayt Semi-Automatique",
            unique_rate: "Ssuma yezgan",
            notice: "Tamawt: Asuter-inek ad t-iwali ubaḍu-nneɣ. Ad k-id-nessiwel deg tilihun akken ad nsentem azemz d lweqt n uɛṣar-inek."
        },
        cart: {
            title: "Aqecwal",
            empty: "Aqecwal d ilem",
            subtotal: "Ssuma n daxil",
            delivery: "Asiweḍ",
            total: "Asemday"
        },
        items: {
            added_to_cart: "Yerna ɣer uqecwal",
            added_desc: "{{qty}} {{name}} yerna.",
            stock_insufficient: "Lqit ur yezmir ara",
            out_of_stock: "Ifuk lqit",
            per_05l: "/ 0.5L",
            custom: "Asmires"
        },
        form: {
            ...
            submitting: "Azen...",
            receiving_mode: "Tarrayt n wawi",
            home_delivery: "Asiweḍ ɣer wexxam",
            local_pickup: "Lqit dagi",
            cart_empty_title: "Aqecwal d ilem",
            cart_empty_desc: "Rnu isufar weqbel ad tsentemeḍ talaba.",
            wilaya_error_title: "Tucḍa",
            wilaya_error_desc: "Fren wilaya ma ulac ameqran.",
            missing_date_title: "Azemz ixuṣ",
            missing_date_desc: "Fren azemz n lqit n talaba-inek.",
            error: "Tucḍa",
            retry: "Ɛawed",
    ...
    dashboard: {
        ...
        overview: {
            title: "Talwiḥt n uxdem",
            administration: "Tanebbaḍt",
            refresh: "Ssedhu",
            loading: "Asali n talwiḥt...",
            sales: "Asemday n tnezzut",
            products: "Isufar",
            pressing: "Asuter n uɛṣar",
            quick_actions: "Axeddim n tɣawla",
            welcome: "Ansuf ɣer umkan-inek n usekyed. Ssexdem iqeffalen n ufella akken ad tesredded isufar-inek, ad tḍebɛeḍ tilabiyin yerna ad t-theyyiḍ timuɣliwin n uɛṣar.",
            add_product: "Rnu asafar",
            view_orders: "Wali tilabiyin",
            manage_pressing: "Ssekfel aɛṣar"
        },
        products: {
            title: "Asefrek n uqerru & ssuma",
            oil_section: "Zzit & Ifarisen",
            pressing_section: "Ssuma n uɛṣar",
            shipping_section: "Ssuma n usiweḍ (Wilayat)",
            global_settings: "Iseglayen imatuten",
            new: "Afaris amaynut",
            new_wilaya: "Rnu wilaya",
            price: "Ssuma",
            stock: "Aḥraz",
            liters: "LITRAT",
            category: "Taggayt",
            standard: "Standard",
            equipment_name: "Isem n tmacint",
            fees: "Lxelaṣ",
            yield: "Afaris",
            percentage_taken: "Amur n lmuilin",
            percentage_desc: "Amur i yettwakksen seg uzemz",
            percentage_hint: "Amur-agi yettwaseqdac iwakken ad nḥaseb amur n lmuilin.",
            search_wilaya: "Nadi wilaya...",
            code: "CODE",
            wilaya_name: "Isem n wilaya",
            shipping_price: "Ssuma n usiweḍ",
            edit_product: "Beddel Afaris",
            create_product: "Afaris amaynut",
            product_name: "Isem n ufaris",
            initial_stock: "Aḥraz n tazwara",
            save: "Eḥrez",
            cancel: "Susem",
            create: "Snulfu",
            adding: "Tmerniwt...",
            delete: "Kkes",
            delete_confirm: "Tebɣiḍ ad tkkseḍ tura amur-agi?",
            delete_success: "Yettwakkes s lfeṛḥ",
            update_success: "Yettwabeddel s lfeṛḥ",
            create_success: "Yettwarna s lfeṛḥ"
        },
        orders: {
            search: "Nadi talaba...",
            filter_all: "Akk statuts",
            status_pending: "Yettrağu",
            status_confirmed: "Yettwasentem",
            status_in_progress: "Deg ubrid",
            status_ready: "Yujad",
            status_delivered: "Yewweḍ",
            status_completed: "Yeffuk",
            status_cancelled: "Yettwakkes",
            hide_blacklisted: "Ffer iḥerziyen",
            show_blacklisted: "Ssekfel iḥerziyen",
            col_date: "AZEMZ",
            col_client: "AMESƔAY",
            col_wilaya: "WILAYA",
            col_price: "SSUMA",
            ...
            notes: "Iwenniten",
            delete: "Kkes",
            delete_confirm: "Tebɣiḍ ad tkkseḍ tura tamawt-agi?",
            delete_success: "Tamawt tettwakkes",
            view_detail: "Wali detals",
            archive: "Archiver",
            blacklist: "Ḥerz",
            unblacklist: "Serreḥ",
            update_status: "Statut yettwassemsu",
            archive_success: "Talaba tettwaḥrez",
            note_saved: "Timawt tettwazen",
            btn_schedule: "Heyyi",
        ...
        pressing: {
            ...
            status_rejected: "Yettwakkes",
            status_completed: "Ifuk",
            col_qty: "LQEṚ",
            col_quality: "LƔENNA",
            col_yield: "RENDEMENT",
            col_payment: "LXELAṢ",
            ...
            reject: "Kkes",
            mark_done: "Fuk",
            set_dates: "Sbeqqes izumaz",
            scheduling: "PROGRAMMATION",
            arrival_date: "Asali n uzemmur",
            collection_date: "Lqit n zzit",
            update_status: "Statut yettwassemsu",
            agenda_title: "Agenda n uɛṣar",
            agenda_desc: "Ssekfel planning n rrendivwat n uɛṣar.",
            to_program: "Iwakken ad yettwaprogrammi (Appels iwakken ad d-ssiwleḍ)",
            planning: "Planning n rrendivwat",
            apport: "ASALI",
            collecte: "LQIT",
            demand_of: "Asuter n",
        ...
        agenda: {
            title: "Planning n Lecɣal",
            desc: "Organisez les passages au moulin et les rendez-vous clients.",
            search_placeholder: "Nadi amsaɣ (Isem neɣ Tilifun)...",
            empty: "Ulac lecɣal i deg-i akka tura.",
            empty_search: "Ulac agmuḍ n unadi-agi.",
            empty_to_schedule: "Akk imsaɣen yettwaprogrammen.",
            unified_planning: "Aseqdec n lecɣal yewden",
            activities: "Lecɣal",
            availability: {
                calendar_title: "Disponibilité n Lemɛisra",
                blocked_dates: "USSAN I YETTWAḤRSEN",
                click_to_block: "Sit ɣef wass iwakken ad tḥerzeḍ neɣ ad tserṛḥeḍ i ufellaḥ.",
                no_blocked: "Ulac ussan i yettwaḥres i tura.",
                dates_count: "USSAN",
                toast_blocked: "Azemz yeqfel!",
                toast_unblocked: "Azemz yeldi!",
                toast_error: "Agul deg ubeddel n tmerniwt"
            },
            pickups: "Lqit & Awi-d",
        ...
        clients: {
            ...
            col_contact: "EMAIL / TEL",
            col_orders: "TILABIYIN",
            col_pressing: "AƐṢAR",
            blacklist_toggle: "Ssekfel iḥerziyen",
            blacklist_hide: "Ffer iḥerziyen",
