export const fr = {
    ...
    dashboard: {
        ...
        products: {
            title: "Gestion du Stock & Tarifs",
            oil_section: "HUILES ET PRODUITS",
            pressing_section: "TARIFS PRESSAGE",
            shipping_section: "TARIFS DE LIVRAISON (WILAYAS)",
            global_settings: "PARAMÈTRES GLOBAUX",
            new: "Nouveau Produit",
            new_wilaya: "Ajouter Wilaya",
            price: "Prix",
            stock: "Stock",
            liters: "LITRES",
            category: "Catégorie",
            ...
            percentage_taken: "POURCENTAGE PRÉLEVÉ",
            percentage_desc: "Taux appliqué sur la récolte",
            percentage_hint: "Ce taux est utilisé pour calculer la part du moulin lors d'un paiement en olives.",
            search_wilaya: "Chercher une wilaya...",
            code: "CODE",
        ...
        orders: {
            ...
            notes: "Notes",
            delete: "Supprimer",
            delete_confirm: "Êtes-vous sûr de vouloir supprimer définitivement cette commande ?",
            delete_success: "Commande supprimée",
        ...
        pressing: {
            ...
            filter_all: "Tous",
            status_pending: "En Attente",
            status_accepted: "EN PROCESSUS",
            status_rejected: "Refusé",
            status_completed: "Terminé",
            mark_in_process: "Remettre en cours",
            col_qty: "QUANTITÉ",
            col_quality: "QUALITÉ",
            col_yield: "RENDEMENT",
