export const en = {
    ...
    boutique: {
        ...
        press: {
            ...
            notice: "Note: Your request will be reviewed by our team. We will contact you by phone to confirm the exact date and time for your pressing."
        },
        form: {
            nom: "Last Name",
    ...
    dashboard: {
        ...
        overview: {
            ...
            sales: "Total Sales",
            products: "Products",
            pressing: "Pressing Requests",
            quick_actions: "Quick Actions",
            welcome: "Welcome to your management space. Use the tabs above to manage your products, track orders, and organize pressing appointments.",
            add_product: "Add a product",
            view_orders: "View orders",
            manage_pressing: "Manage pressing"
        },
        products: {
            title: "Dynamic Rate Management",
            oil_section: "Oil Price & Stock & Products",
            pressing_section: "Equipment & Pressing Fees (DA/kg)",
            shipping_section: "Shipping Rates (Wilayas)",
            global_settings: "Global Service Settings",
            new: "New",
            new_wilaya: "New Wilaya",
            price: "Price",
            stock: "Stock",
            liters: "Liters",
            category: "Category",
            ...
            fees: "Fees (DA/kg)",
            yield: "Yield (L/kg)",
            percentage_taken: "Collection Percentage (%)",
            percentage_desc: "of the produced oil will be retained by the producer as service payment.",
            percentage_hint: "This is what you retain as payment if the client does not pay in cash.",
            search_wilaya: "Search a wilaya...",
            code: "Code",
            wilaya_name: "Wilaya Name",
            shipping_price: "Shipping Price (DA)",
            edit_product: "Edit Product",
            create_product: "New Product",
            product_name: "Product Name",
            initial_stock: "Initial Stock (Liters)",
            save: "Save",
            cancel: "Cancel",
            create: "Create",
            adding: "Adding...",
        ...
        orders: {
            ...
            hide_blacklisted: "Hide Restricted",
            show_blacklisted: "Manage Restricted",
            col_date: "DATE",
            col_client: "CLIENT",
            col_wilaya: "WILAYA",
            col_price: "PRICE",
            ...
            archive_success: "Order archived",
        ...
        pressing: {
            ...
            arrival_date: "Olives Arrival",
            collection_date: "Oil Collection",
            update_status: "Status updated",
            agenda_title: "Pressing Agenda",
            agenda_desc: "Manage the pressing appointments schedule.",
            to_program: "To program (Calls to make)",
        ...
        clients: {
            ...
            col_orders: "ORDERS",
            col_pressing: "PRESSING",
            blacklist_toggle: "Manage Restricted",
            blacklist_hide: "Hide Restricted",
            empty: "No client profile detected."
        },
        pickup_modal: {
        ...
        agenda: {
            ...
            desc: "Organize mill visits and client appointments.",
            search_placeholder: "Search a client (Name or Phone)...",
            empty: "No activity scheduled.",
            empty_search: "No results for this search.",
            empty_to_schedule: "All clients are scheduled.",
            unified_planning: "Unified Newsfeed & Planning",
            activities: "Activities",
            availability: {
                calendar_title: "Mill Availability",
                blocked_dates: "BLOCKED DATES",
                click_to_block: "Click on a date to block/unblock it in the client booking calendar.",
                no_blocked: "No blocked dates for now.",
                dates_count: "DATES",
                toast_blocked: "Date blocked!",
                toast_unblocked: "Date unblocked!",
                toast_error: "Error updating availability"
            },
            pickups: "Pickups & Deliveries",
            pressing: "Scheduled Pressings",
            type_pickup: "Pickup",
